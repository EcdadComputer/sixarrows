...
const i18n = {
    ...
    "inst-p": {
        ...
        "km": "Sie erhalten eine Reihe von Stellungnahmen. Klicken Sie jeweils auf die Schaltfläche mit Ihrer Meinung dazu.",
    ...
    "result-url": {
        ...
        "km": "<br>Sie können diese Ergebnisse senden, indem Sie die URL oben auf der Seite kopieren und einfügen oder das folgende Bild verwenden.",
    ...
    "result-h2-match": {
        ...
        "km": "Höchste Übereinstimmung: <span class='weight-300' id='ideology-label'> </span>",
    ...
    "result-h2-next-matches": {
        ...
        "km": "Nächst höchste Überstimmungen",
        "ko": "다음으로 일치하는 성향",
    ...
    "next-matches-percent": {
        ...
        "km": "Hier sind die Ideologien mit denen du am meisten übereinstimmst, wo volle Übereinstimmung 100% ist und keine 0%.",
    ...
    "result-h2-score": {
        ...
        "km": "Ich mag meine Ergebnisse nicht",
    ...
    "result-a-label": {
        "en": ["Extremely Republican","Very Republican","Republican","Neutral","Authoritarian","Very Authoritarian","Extremely Authoritarian"],
        "km": ["Extrem Revolutionär", "Sehr Revolutionär", "Revolutionär", "Neutral", "Reformistisch", "Sehr Reformistisch", "Extrem Reformistisch"],
    ...
    "result-b-label": {
        "en": ["Extremely Populist","Very Populist","Populist","Neutral","Non-Populist","Very Non-Populist","Extremely Non-Populist"],
        "km": ["Extrem Wissenschaftlich", "Sehr Wissenschaftlich", "Wissenschaftlich", "Neutral", "Utopisch", "Sehr Utopisch", "Extrem Utopisch"],
    ...
    "result-c-label": {
        "en": ["Extremely Etatist","Very Etatist","Etatist","Neutral","Capitalist","Very Capitalist","Extremely Capitalist"],
        "km": ["Extrem Zentralisiert", "Sehr Zentralisiert", "Zentralisiert", "Neutral", "Dezentralisiert", "Sehr Dezentralisiert", "Extrem Dezentralisiert"],
    ...
    "result-d-label": {
        "en": ["Extremely Nationalist","Very Nationalist","Nationalist","Neutral","Globalist","Very Globalist","Extremely Globalist"],
        "km": ["Extrem Nationalistisch", "Sehr Nationalistisch", "Nationalistisch", "Neutral", "Globalistisch", "Sehr Globalistisch", "Extrem Globalistisch"],
    ...
    "result-e-label": {
        "en": ["Extremely Secular","Very Secular","Secular","Neutral","Religious","Very Religious","Fundamentalist"],
        "km": ["Extrem Parteiisch", "Sehr Parteiisch", "Parteiisch", "Neutral", "Gewerkschaftlich", "Sehr Gewerkschaftlich", "Extrem Gewerkschaftlich"],
    ...
    "result-f-label": {
        ...
        "km": ["Extrem Produktivist", "Sehr Produktivist", "Produktivist", "Neutral", "Ökologisch", "Sehr Ökologisch", "Extrem Ökologisch"],
    ...
    "result-g-label": {
        "en": ["Extremely Progressive","Very Progressive","Progressive","Neutral","Conservative","Very Conservative","Extremely Conservative"],
        "km": ["Extrem Konservativ", "Sehr Konservativ", "Konservativ", "Neutral", "Progressiv", "Sehr Progressiv", "Extrem Progressiv"],
    ...
    "index-b-start": {
        ...
        "km": "Klicke hier um anzufangen!",
        "ko": "클릭해서 시작하기!",
        "ru": "Начать тест"
    },
    "index-h2-whatis" : {
        "en": "What is LeftValues?",
        "km": "Was ist LeftValues?",
    ...
    "index-p-answer": {
        ...
        "km": "LeftValues ist ein linkes Quiz, das von dem Quiz <a href='https://8values.github.io/'>8values</a> inspiriert ist und auf diesem basiert und versucht, Ihre Position im linken Spektrum zu bestimmen." +
    ...
    "index-sixaxes": {
        ...
        "km": "Derzeit gibt es sechs Achsen, von denen jede zwei entgegengesetzte Werte hat. Sie sind:",
    ...
    "index-rev-desc": {
        ...
        "km": "<b style='color:#890000;'>Revolution</b> <b>vs.</b> <b style='color:#FC5959;'>Reform</b><br/>" +
    ...
    "index-sci-desc": {
        "en": "<b style='color:#88232B;'>Populist</b> <b>vs.</b> <b style='color:#7F0037;'>Non-Populist</b><br/>" +
        "Those with a higher Populist score tend to support or sympathize with the Marxist analysis of society along the lines of dialectical materialism. Those with a higher Non-Populist score tend to believe in a more idealistic analysis of society and reject materialist approaches.",
        "km": "<b style='color:#88232B;'>Wissenschaftlich</b> <b>vs.</b> <b style='color:#7F0037;'>Utopisch</b><br/>" +
    ...
    "index-cent-desc": {
        ...
        "km": "<b style='color:#560000;'>Zentralisiert</b> <b>vs.</b> <b style='color:#000000;'>Dezentralisiert</b><br/>" + 
    ...
    "index-int-desc": {
        ...
        "km": "<b style='color:#782F52;'>International</b> <b>vs.</b> <b style='color:#7F3300;'>National</b><br/>" +
    ...
    "index-party-desc": {
        ...
        "km": "<b style='color:#963B33;'>Partei</b> <b>vs.</b> <b style='color:#7F333B;'>Gesellschaft</b><br/>" +
    ...
    "index-prod-desc": {
        ...
        "km": "<b style='color:#804E00;'>Produktion</b> <b>vs.</b> <b style='color:#76890B;'>Ökologie</b><br/>" +
    ...
    "index-cons-desc": {
        ...
        "km": "<b style='color:#27577A;'>Konservativ</b> <b>vs.</b> <b style='color:#C4A717;'>Progressiv</b><br/>" +
    ...
    "index-p-tracked": {
        ...
        "km": "LeftValues verwendet ein sehr einfaches Tracking, um sich einen Überblick über die Anzahl der Besucher zu verschaffen. Es werden keine persönlichen Informationen gesammelt und Antworten/Ergebnisse werden nicht gespeichert. Wenn Sie mir nicht glauben, ist der Code Open Source und für alle sichtbar.",
