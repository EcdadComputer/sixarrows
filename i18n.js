...
const i18n = {
    ...
    "inst-p": {
        "pk": "You will be presented with a series of statements. For each one, click the button with your opinion on it.",
    ...
    "result-url": {
        "pk": "<br>You can send these results by copying and pasting the URL at the top of the page or using the image below.",
        "de": "<br>Bu sonuçları yukarıdaki URL'yi kopyalayıp yapıştırarak veya alttaki görseli kullanarak paylaşabilirsiniz.",
    },
    "result-h2-match": {
        "pk": "Closest Match: <span class='weight-300' id='ideology-label'> </span>",
        "de": "En Yakın Sonuç: <span class='weight-300' id='ideology-label'> </span>",
    },
    "result-h2-next-matches": {
        "pk": "Next closest matches",
        "de": "Diğer yakın sonuçlar",
    },
    "next-matches-percent": {
        "pk": "With your closest match as 100% and farthest as 0%, here is how closely you matched the other ideologies.",
    ...
    "result-h2-score": {
        "pk": "Sonuçlarımı beğenmedim!",
        "de": "Ich mag meine Ergebnisse nicht",
        "ko": "제 결과가 마음에 들지 않습니다.",
        "ru": "Мне не нравятся мои результаты!"
    },
    "result-issues": {
        "pk": "</a><a href='https://github.com/SixAxes/leftvalues.github.io'>GitHub Page</a>.",
        "de": "Bu testin çok gerçekçi olmasını beklemeyin. Öylesine eğlence için hazırladım. Ama eğer belirtmek istediğiniz bir durum var ise github.com/EcdadComputer/sixaxes adresinden konu açıp durumu belirtebilirsiniz.",
        "ko": `어떠한 범주에서든 100%의 점수를 얻을 수 없다는 것을 기억하십시오. 이 설문의 목적은 당신 자신의 관점에 직면하는 것에 있습니다. 의견이나 건설적인 비판은 <a href="https://forms.gle/6WZYMb5GXkkDLhxr5">이 양식</a>이나 <a href="https://github.com/SixAxes/leftvalues.github.io">GitHub Page</a>의 이슈를 통해 개진할 수 있습니다.`,
        "ru": "Пожалуйста, помните, что вы не намерены получить 100%-ый результат ни в одной из осей. Смысл викторины заключается в том, чтобы оспорить ваши взгляды. Если у вас какие-либо предложения или конструктивная критика, то, пожалуйста, заполните эту <a href='https://forms.gle/6WZYMb5GXkkDLhxr5'>короткую форму</a> или откройте вкладку ''issue'' на <a href='https://github.com/SixAxes/leftvalues.github.io'>странице GitHub</a>."
    },
    "result-a-label": {
        "pk": ["Extreme Republican","Very Republican","Republican","Neutral","Autocrat","Very Autocrat","Extremely Autocrat"],
        "de": ["Aşırı Cumhuriyetçi", "Çok Cumhuriyetçi", "Cumhuriyetçi", "Neutral", "Otokrat", "Çok Otokrat", "Aşırı Otokrat"],
    ...
    "result-b-label": {
        "pk": ["Extremely Populist","Very Populist","Populist","Neutral","","",""],
        "de": ["Aşırı Halkçı", "Çok Halkçı", "Halkçı", "Neutral", "", "", ""],
    ...
    "result-c-label": {
        "pk": ["Extremely Etatist","Very Etatist","Etatist","Neutral","Capitalist","Very Capitalist","Extremely Capitalist"],
        "de": ["Aşırı Devletçi", "Çok Devletçi", "Devletçi", "Neutral", "Kapitalist", "Çok Kapitalist", "Aşırı Kapitalist"],
    ...
    "result-d-label": {
        "pk": ["Extremely Nationalist","Very Nationalist","Nationalist","Neutral","Globalist","Very Globalist","Extremely Globalist"],
        "de": ["Aşırı Milliyetçi", "Çok Milliyetçi", "Milliyetçi", "Neutral", "Küreselci", "Çok Küreselci", "Aşırı Küreselci"],
    ...
    "result-e-label": {
        "pk": ["Extremely Secular","Very Secular","Secular","Neutral","Religious","Very Religious","Fundamentalist"],
        "de": ["Aşırı Laik", "Çok Laik", "Laik", "Neutral", "Dindar", "Çok Dindar", "Köktendinci"],
	...
	"result-f-label": {
        "pk": ["Extremely Productivist","Very Productivist","Productivist","Neutral","Ecological","Very Ecological","Extremely Ecological"],
    ...
    "result-g-label": {
        "pk": ["Extremely Progressive","Very Progressive","Progressive","Neutral","Conservative","Very Conservative","Extremely Conservative"],
        "de": ["Aşırı İnkılapçı", "Çok İnkılapçı", "İnkılapçı", "Neutral", "Muhafazakar", "Çok Muhafazakar", "Aşırı Muhafazakar"],
    ...
    // index.html
    "index-b-start": {
        "pk": "Click here to start!",
        "de": "Başlamak için tıkla!",
        "ko": "클릭해서 시작하기!",
        "ru": "Начать тест"
    },
    "index-h2-whatis" : {
    ...
    "index-p-answer": {
        ...
        "ko": `SixAxes는 <a href="https://8values.github.io/">8values</a>의 영감을 받아 좌익 스펙트럼 상에서 당신의 위치를 파악하기 위해 만들어진 좌익 설문입니다. 만약 당신이 좌파가 아니라면, 이 설문은 당신에게 적합하지 않을 것입니다.
        ...
        "ru": "SixAxes — это ''левая'' политическая викторина, вдохновлённая и основанная на викторине <a href='https://8values.github.io/'>8values</a>, цель которой — определить вашу позицию на левом политическом спектре. " + 
    ...
    "index-h2-whatvalues": {
        "pk": "What are the values?",
        "de": "Was sind die Werte?",
        "ko": "가치(values)는 무엇입니까?",
        "ru": "За что отвечают значения?"
    },
    "index-sixaxes": {
        "pk": "There are currently six axes, each of which has two opposing values. They are:",
    ...
    "index-rev-desc": {
        "pk": "<b style='color:#890000;'>Revolution</b> <b>vs.</b> <b style='color:#FC5959;'>Reform</b><br/>" +
    ...
    "index-sci-desc": {
        "pk": "<b style='color:#88232B;'>Scientific</b> <b>vs.</b> <b style='color:#7F0037;'>Utopian</b><br/>" +
    ...
    "index-cent-desc": {
        "pk": "<b style='color:#560000;'>Central</b> <b>vs.</b> <b style='color:#000000;'>Decentral</b><br/>" + 
    ...
    "index-int-desc": {
        "pk": "<b style='color:#782F52;'>International</b> <b>vs.</b> <b style='color:#7F3300;'>National</b><br/>" +
    ...
    "index-party-desc": {
        "pk": "<b style='color:#963B33;'>Party</b> <b>vs.</b> <b style='color:#7F333B;'>Union</b><br/>" +
    ...
    "index-prod-desc": {
        "pk": "<b style='color:#804E00;'>Production</b> <b>vs.</b> <b style='color:#76890B;'>Nature</b><br/>" +
    ...
    "index-cons-desc": {
        "pk": "<b style='color:#27577A;'>Conservative</b> <b>vs.</b> <b style='color:#C4A717;'>Progressive</b><br/>" +
    ...
    "index-h2-closest": {
        "pk": "What does \"Closest Match\" mean in the results?",
